...
public class InitData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        petsRepo.save(new Pet("ash", "dog", "black", "big", owner1, emp1, "pending"));
        petsRepo.save(new Pet("bill", "cat", "orange", "medium", owner2, emp2, "waiting"));
        petsRepo.save(new Pet("lil", "bird", "white", "small", owner3, emp3, "waiting"));
        petsRepo.save(new Pet("lil2", "bird", "white", "small", owner1, emp1, "adopted"));
        petsRepo.save(new Pet("lil3", "bird", "white", "small", owner2, emp1, "pending"));
        petsRepo.save(new Pet("lil4", "bird", "white", "small", owner3, emp2, "pending"));
